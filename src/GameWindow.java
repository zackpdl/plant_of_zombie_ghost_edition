...
public class GameWindow extends JFrame {
    ...
    public GameWindow() {
        ...
        PlantCard shortrange = new PlantCard(new ImageIcon(this.getClass().getResource("images/cards/card_wallnut.png")).getImage());
        shortrange.setLocation(305, 8);
        shortrange.setAction((ActionEvent e) -> {
            gp.setActivePlantingBrush(PlantType.ShortRange);
        });
        getLayeredPane().add(shortrange, new Integer(3));
